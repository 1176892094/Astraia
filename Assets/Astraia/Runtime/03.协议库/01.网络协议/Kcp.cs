        ...
        public static int ikcp_input(IKCPCB* kcp, byte* data, long size)
        {
            ...
            while (true)
            {
                ...
                if (cmd == IKCP_CMD_ACK)
                {
                    ...
                    {
                        ikcp_log(kcp, (int)IKCP_LOG_IN_ACK, "input ack: sn={0} rtt={1} rto={2}", (ulong)sn, (long)_itimediff(kcp->current, ts), (long)kcp->rx_rto);
                    }
                }
                else if (cmd == IKCP_CMD_PUSH)
                {
                    ...
                    {
                        ikcp_log(kcp, (int)IKCP_LOG_IN_DATA, "input psh: sn={0} ts={1}", (ulong)sn, (ulong)ts);
                    }
                ...
                else if (cmd == IKCP_CMD_WINS)
                {
                    ...
                    {
                        ikcp_log(kcp, (int)IKCP_LOG_IN_WINS, "input wins: {0}", (ulong)wnd);
                    }
                }
                else
                {
