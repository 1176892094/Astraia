...
namespace Astraia.Net
{
    public partial class NetworkManager
    {
        public static partial class Server
        {
            ...
            public static bool isReady => connections.All(client => client.isReady);
            public static ICollection<NetworkClient> connections => clients.Values;
        ...
        public static partial class Server
        {
            private static void AddMessage(bool isHost)
            {
                if (!isHost)
                {
                    current.server.onConnect -= Connect;
                    current.server.onDisconnect -= Disconnect;
                    current.server.onReceive -= Receive;
                    current.server.onConnect += Connect;
                    current.server.onDisconnect += Disconnect;
                    current.server.onReceive += Receive;
                }
        ...
        public partial class Server
        {
            internal static void Connect(int id)
            {
                ...
                var connection = new NetworkClient();
